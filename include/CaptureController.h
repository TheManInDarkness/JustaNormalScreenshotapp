...
// Finishes a text extraction: puts `ocr`'s text on the clipboard, flashes
// `flashRegion` (pass an empty rect to skip) and toasts the outcome. Shared
// by the live capture path and the gallery's Extract text tool, so both
// report the same way.
