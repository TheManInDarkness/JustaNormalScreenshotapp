...
// Copies `text` as CF_UNICODETEXT. Like CopyBitmap, this replaces whatever
// the clipboard held: EmptyClipboard is all-or-nothing, so image and text
// copies never coexist - the most recent copy wins, which is what both
// callers and paste targets expect.
